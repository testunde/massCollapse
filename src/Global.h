...
#define ENVIRONMENT_HEIGHT 300 // [m]
#define ENVIRONMENT_SPAWN_THICKNESS 50 // [m]
#define ENVIRONMENT_SPAWN_DROPS_TOTAL .05E5 // hint: accretion (merging) occur beginning at 1E4 drop/m^2
...
#define VISU_WIDTH_PX_PER_METER 1.5*8000 // [px/m]
#define VISU_HEIGHT_PX_PER_METER 02.5 // [px/m]
